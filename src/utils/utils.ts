...
const templatesCache = new Map<string | HTMLTemplateElement, HTMLElement>();

export function cloneTemplate<T extends HTMLElement>(
	query: string | HTMLTemplateElement
): T {
	const cachedTemplate = templatesCache.get(query);
	const template = (cachedTemplate ||
		ensureElement(query)) as HTMLTemplateElement;
